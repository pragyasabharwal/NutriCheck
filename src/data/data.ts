...
const quiz: Quiz[] = [{
  ...
  questions: [
    ...
    {
      question: "How many calories does a medium serving of french fries from McDonald's contain?",
      id: 6,
      points: 5,
      negativePoint: 2,
      options: [
    ...
    {
      question: "How many calories does a yummy plate of Pav Bhaji (a famous dish from Marathi Cuisine) contain?",
      id: 7,
      points: 5,
      negativePoint: 2,
      options: [
...
{quizTitle: "vitamins",
  ...
  questions: [
    ...
    {
      question:
        "What is the national fruit of both India and Pakistan?",
      id: 7,
      points: 5,
      options: [
        {
